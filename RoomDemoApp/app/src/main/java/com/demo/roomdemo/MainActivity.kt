    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        saveButton.setOnClickListener {
            ...
            if(saveButton.text.equals("Save")) {
                ...
                val id = viewModel.insertUserInfo(user)
                Log.e("=====", "=======id : " +id)
                //INSERT INTO DATABSE TABLE WITH REFERENCE OF PRIMARY KEY in USER TABLE and FOREIGN KEY in ADDRESS TABLE.
                viewModel.insertAddress(Address(0, id.toString(), "150", "ssdd", "NY", "000999"))
            } else {
